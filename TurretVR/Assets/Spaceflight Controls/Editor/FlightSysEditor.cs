...
public class CustomPointerEditor : Editor 
{
	public override void OnInspectorGUI()
	{
		...
		if (pointer.use_mouse_input) {
			...
			pointer.use_mobile_input = EditorGUILayout.Toggle(new GUIContent("Use Mobile", "Pointer will use mobile joystick controls."), pointer.use_mobile_input);
            ...
            pointer.use_mobile_input = EditorGUILayout.Toggle(new GUIContent("Use Mobile", "Pointer will use mobile joystick controls. Uncheck to choose another input option."), pointer.use_mobile_input);
        }
